        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={cn(
            ...
            <div className="relative rounded-2xl overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1558979178-8697b1492b8c?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3" 
              ...
              <div className="absolute bottom-0 right-0 w-3/4 transform translate-y-1/4 translate-x-1/6">
                <img 
                  src="https://images.unsplash.com/photo-1558981408-db0ecd8a1ee4?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3" 
          ...
          <div className={cn(
            ...
            <h2 className="section-title text-left">Sleek. Modern.<br/>Unmistakable.</h2>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={index} className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-brand-teal/20 flex items-center justify-center mr-3">
            ...
            <Button 
              className="bg-brand-teal hover:bg-brand-teal/90 text-white px-8 py-6 rounded-md btn-hover-effect"
              size="lg"
            >
              EXPLORE DESIGN
            </Button>
